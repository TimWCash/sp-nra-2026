...
export const schedule: Record<string, ScheduleEvent[]> = {
  fri: [
    ...
    { time: "Evening", title: "Team dinner", sub: "Final prep for tomorrow" },
  ],
  sat: [
  ...
  sun: [
    ...
    { time: "2:45pm", title: "\u2691 BE AT S-401 \u2014 Brian + Steve + Rebecca", sub: "Hard arrival deadline. Walk together to South Building, Level 4 (escalator/elevator from Grand Concourse next to the Show activation, one level above South Hall). Late = lose the slot.", highlight: "close" },
    { time: "3:00pm", title: "2027 Booth Selection \u2014 3:00\u20133:15 PM CT", sub: "Room S-401 (South Bldg, Level 4). Brian + Steve + Rebecca only. Bring top 5 booth picks from the live floorplan (BLUE = available). Hard 5-min cap once called into the room. ALL decision-makers must be in the room together \u2014 no stepping out to consult, no running back to the booth.", highlight: "open" },
    { time: "5:00pm", title: "Show Floor Closes", highlight: "close" },
    { time: "Evening", title: "Daily Debrief", sub: "Adjust for tomorrow. Log leads. Restock collateral." },
  ],
  mon: [
...
export const afterHoursEvents: AfterHoursEvent[] = [
  ...
  {
    id: "sat-international-reception",
    night: "sat",
    time: "5:00 PM – 6:00 PM",
    title: "International Reception",
    host: "NRA Show",
    venue: "Vista Ballroom, S406, McCormick Place",
    address: "2301 S King Dr, Chicago",
    cost: "Free (badge required)",
    access: "badge",
    link: "https://www.nationalrestaurantshow.com/home/international-reception/",
    notes: "Official NRA reception for international attendees (110+ countries). Right after the show floor closes — zero travel friction. International multi-unit operators are often exploring US expansion — natural ops-consulting prospects.",
    type: "happy-hour",
    confirmed: true,
  },
  {
    id: "sat-tiphaus-alliance",
    night: "sat",
    time: "5:00 PM – 7:00 PM",
    title: "TipHaus + AllianceHCM + rapid! Happy Hour",
    host: "TipHaus, AllianceHCM, rapid!",
    venue: "Legal Sea Foods — Upstairs Oyster Bar",
    address: "Chicago (river views)",
    cost: "Free (RSVP required — operators-only)",
    access: "rsvp",
    link: "https://www.tiphaus.com/events/NRA-happy-hour-with-AllianceHCMandRapid/",
    notes: "Restaurant operators + invited hospitality leaders only — vendor/service-provider registrations may be declined. TipHaus = tip-pool automation, AllianceHCM = restaurant HR/payroll, rapid! = same-day pay. Limited space — RSVP early.",
    type: "happy-hour",
    confirmed: true,
  },
  {
  ...
  },
  {
    ...
    title: "Maple x Ordinary Theory Happy Hour",
    host: "Maple + Ordinary Theory (Reid Rothman, Aidan Chau)",
    venue: "VU Rooftop",
    address: "133 E Cermak Rd, Chicago (~0.5mi from McCormick)",
    cost: "Free (RSVP required — approval needed)",
    access: "rsvp",
    link: "https://luma.com/sqljxc9c",
    notes: "Drinks + skyline views with the Maple team (front-of-house automation tech) and Ordinary Theory crew. Same rooftop as Mon's Harri + ADP event. Request-to-join via Luma — hosts approve individually.",
    type: "happy-hour",
    confirmed: true,
  },
  {
  ...
  {
    id: "mon-bear-icebox-backroom",
    night: "mon",
    time: "5:00 PM – 8:00 PM CDT",
    title: "The Backroom — Bear Icebox",
    host: "Bear Icebox (DeAnna Spoerl)",
    venue: "M House",
    address: "800 W 27th St, Chicago (~2mi SW of McCormick — rideshare)",
    cost: "Free (Invite Only — RSVP required)",
    access: "invite",
    link: "https://luma.com/wzmebou0",
    notes: "Invite-only evening for leaders across food, beverage, retail, and manufacturing. Cocktails, small bites (5–6pm), cigars in the back lounge, limited-edition Don Julio raffle. Theme: \"What's actually driving growth right now — and what's quietly losing relevance?\" Drop in before dinner, stay as long as you'd like. ~35 going.",
    type: "happy-hour",
    confirmed: true,
  },
  {
    id: "mon-cornell-hotel-society",
    night: "mon",
    time: "5:00 PM – 7:00 PM CDT",
    title: "Cornell Hotel Society Cocktail Party",
    host: "Chicago Chapter of the Cornell Hotel Society",
    venue: "Blackstone Hotel",
    address: "636 S Michigan Ave (lobby entrance on E Balbo Dr), Chicago",
    cost: "$50–$75 (paid) · $50 Young Alumni / $70 Lobby Member / $75 General",
    access: "paid",
    link: "https://thelobby.cornellhotelsociety.com/events/246472",
    notes: "Cornell Hotel Society's longest-standing NRA event — networking, beer/wine/soda, small bites. Re-launch of the chapter with new board introduction; Cheryl Stanley + Doug Miller (Cornell faculty) on the floor. Walkable from McCormick (~1.5mi up Michigan Ave). Note: paid event — outside the usual free/RSVP rule.",
    type: "happy-hour",
    confirmed: true,
  },
  {
  ...
  },
  {
    ...
    notes: "⚠️ SOLD OUT as of last check. Kept in list as context — historic Glessner House venue, cocktails + light bites + live music by Robert Perlick-Molinari. Walkable from McCormick. Worth checking the link day-of in case of releases.",
    type: "happy-hour",
    confirmed: true,
  },
  {
